...
def train_model(input_to_softmax, 
    ...
    # add checkpointer
    checkpointer = ModelCheckpoint(filepath='results/'+save_model_path, monitor="val_loss", save_best_only=True, verbose=1)
    ...
    hist = model.fit(audio_gen.next_train(), steps_per_epoch=steps_per_epoch,
        ...
        callbacks=[checkpointer, early_stopping, termOnNaN], verbose=verbose)
